...
class PolymathConnectionManager:
    ...
    def on_ws_message(self,msg):
        ...
        if msg['code'] == 403 and msg['type'] == "Shortcut error":
            self.notificationCallback("Denied Access", "Our context switching request was denied. In order to have consistent context switching please approve these requests. Or if you would like automation then allow promptless switching in Polymath settings") 
